...
#define __STM8L10X_STDPERIPH_VERSION_SUB2   ((uint8_t)0x00) /*!< [15:8]  sub2 version */
...
#define COMP_CR_CNFTIM        ((uint8_t)0x60) /*!< Connect ouput conparator configuration Mask. */
...
#define COMP_CSR_COMP2OUT     ((uint8_t)0x02) /*!<  Second Comparator Ouptput Mask. */
#define COMP_CSR_COMP1OUT     ((uint8_t)0x01) /*!<  First Comparator Ouptput Mask. */
